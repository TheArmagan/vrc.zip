...
export function helpText(): string {
  return [
    ...
    "    --tray, --no-tray                 the notification-area icon (Windows). On by default.",
    "    --hidden                          start with the console window hidden. Needs the tray",
    "                                      icon to put it back, and is ignored without one.",
    "    --uninstall                       remove the installed copy, its shortcuts and its",
    "                                      registry entries. Your accounts and settings stay.",
    "    --help, -h                        this",
