...
const EVENT_LABELS: Readonly<Partial<Record<BusEventKind, string>>> = {
  ...
  // The generic kind now means one specific thing: the first update seen for that friend, where
  // there was no previous copy to compare against. Every other update names the field it moved.
  "friend.updated": "Friend profile changed",
  "friend.updated.name": "Friend renamed",
  "friend.updated.avatar": "Friend changed avatar",
  "friend.updated.icon": "Friend changed picture",
  "friend.updated.bio": "Friend changed bio",
  "friend.updated.status": "Friend changed status",
  "friend.updated.status_message": "Friend changed status message",
  "friend.updated.trust": "Friend trust rank changed",
  "friend.updated.platform": "Friend changed platform",
  "friend.added": "Friend added",
  "friend.removed": "Friend removed",
  "user.updated": "Your profile changed",
  "user.updated.name": "You were renamed",
  "user.updated.avatar": "You changed avatar",
  "user.updated.icon": "You changed picture",
  "user.updated.bio": "You changed bio",
  "user.updated.status": "You changed status",
  "user.updated.status_message": "You changed status message",
  "user.updated.trust": "Your trust rank changed",
  "user.updated.platform": "You changed platform",
  ...
  "gamelog.instance_ready": "Instance loaded",
  ...
  "gamelog.avatar_change": "Avatar changed",
  "gamelog.video_play": "Video played",
  "gamelog.download": "Download",
  "gamelog.sticker_spawn": "Sticker dropped",
  "gamelog.prop_spawn": "Prop spawned",
  "gamelog.device_change": "Audio device changed",
  "gamelog.osc_ready": "OSC ready",
  "gamelog.environment": "Client hardware",
  "gamelog.api_failure": "Client API failure",
  "gamelog.notification": "Notification in log",
  "gamelog.friend_updated": "Friend updated in log",
  ...
  "economy.update.wallet_balance": "Credit balance changed",
  "economy.update.vrchat_plus": "VRChat Plus changed",
